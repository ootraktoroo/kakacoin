KakaCoin (KKC) - a 'faster' version of Litecoin which also uses scrypt
...
So actually, this 'new' coin exists for the following reasons:
 - KKC proves that really anyone(!) can start a Litecoin/Bitcoin based currency
...
Finally, I only tested the command line server/tool 'kakacoin' for the
