...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // KakaCoin: 0.35 days
static const int64 nTargetSpacing = 5; // KakaCoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal kakacoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "KakaCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8b03da3c93e3143a8a5a62f30ee936113026150cc53878ef0d671531a1f227d1");
    }
    ...
    //0xa50faf35e1dddf4a076a907fbcef6d9d1595390cdb1c818a35dae53b67ad0aa8
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Saturday, February 3, 2018 5:35:43 PM";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        if (fTestNet)
        {
            block.nTime    = 1517685156;
            block.nNonce   = 1822545;
        }
        ...
        assert(block.hashMerkleRoot == uint256("d8b989e87e88b1b8bac51d8c442c50d26548e31bb8941654b10f6869d1370135"));
